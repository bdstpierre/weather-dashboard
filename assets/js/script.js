...
function searchApi(query) {
  ...
  var locQueryUrl = 'api.openweathermap.org/data/2.5/weather';
  var locDailyQueryUrl = 'pi.openweathermap.org/data/2.5/forecast/daily';
  var apiKey = '&appid=ae645017a7275733894562a7a4d6f737';
